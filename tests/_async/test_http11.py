...
@pytest.mark.anyio
async def test_http11_request_body_buffer_is_passed_through():
    """
...
@pytest.mark.anyio
async def test_http11_request_body_buffer_chunked():
    """
...
@pytest.mark.anyio
async def test_http11_request_body_buffer_itemsize_normalised():
    """
